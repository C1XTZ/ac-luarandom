...
![Demo](../.github/img/xtz_loading.gif)
...
2. Open Content Manager and in your Custom Shaders Settings, go to `UI > Loading` and enable `Replace original CSP implementation with a custom script`
